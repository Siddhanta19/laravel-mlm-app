...
<head>
    ...
    <title>LavEarn | MLM with Ease</title>
    ...
    <div
        ...
        @if (Route::has('login'))
            <div class="fixed top-0 right-0 hidden px-6 py-4 sm:block">
                @auth
                    <a class="text-sm text-gray-700 underline dark:text-gray-500"
                        href="{{ url('/dashboard') }}">Dashboard</a>
                @else
                    <a class="text-sm text-gray-700 underline dark:text-gray-500" href="{{ route('login') }}">Log in</a>

                    @if (Route::has('register'))
                        <a class="ml-4 text-sm text-gray-700 underline dark:text-gray-500"
        ...
        <div class="mx-auto max-w-6xl sm:px-6 lg:px-8">
            ...
            <div class="mt-4 flex justify-center sm:items-center sm:justify-between">
                <div class="text-center text-sm text-gray-500 sm:text-left">
                    <div class="flex items-center">
                        <svg class="-mt-px h-5 w-5 text-gray-400" fill="none" stroke-linecap="round"
                        ...
                        <svg class="ml-4 -mt-px h-5 w-5 text-gray-400" fill="none" stroke="currentColor"
                            stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24">
                            <path
